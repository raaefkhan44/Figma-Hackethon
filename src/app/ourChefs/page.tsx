  ...
  return (
    <div>
      ...
      Chefs
        ...
        <div>
  <Image src="/chef1.png" alt="Chef 1" className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer" />
  <Image src="/chef2.png" alt="Chef 2" className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
  <Image src="/chef3.png" alt="Chef 3" className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
  <Image src="/chef4.png" alt="Chef 4" className="w-[200px] md:w-[280px] md:h-[280px] cursor-pointer" />
</div>
